...
public class RemoteSSHConnectionsUtil {

    private static Map<String, RemoteSSHConnection> remoteSSHConnectionsMap = new HashMap<>();

    private static RemoteSSHConnection remoteSSHConnection;
    ...
    public static RemoteSSHConnection getLastRemoteSSHConnection() {
        return remoteSSHConnection;
    }

    public static String getLastRemoteSSHConnectionId() {
